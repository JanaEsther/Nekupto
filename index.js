...
<img class="card-img-top" src="${product2.image}" alt="Slepičkabelka">
  ...
  <button type="button" class="btn btn-lg btn-primary btn-block">Není skladem</button>
`;
...
const firstProductCart = document.querySelector('#product1');
...
const firstProductCardTitle = document.querySelector('#product1 .card-title');
firstProductCardTitle.classList.toggle('text-center');

const secondProductCardTitle = document.querySelector('#product2 .card-title');
secondProductCardTitle.classList.toggle('text-center');
